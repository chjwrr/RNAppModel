...
@property(assign,nonatomic)BOOL isShowLongTime;
@property(strong,nonatomic)NSString *pickerLongTimeText;
@property(strong,nonatomic)NSString *pickerLongTimeFontSize;
@property(strong,nonatomic)NSArray*pickerLongTimeFontColor;
@property(strong,nonatomic)NSArray*pickerLongTimeBg;
