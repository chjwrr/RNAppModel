...
-(instancetype)initWithFrame:(CGRect)frame dic:(NSDictionary *)dic leftStr:(NSString *)leftStr centerStr:(NSString *)centerStr rightStr:(NSString *)rightStr topbgColor:(NSArray *)topbgColor bottombgColor:(NSArray *)bottombgColor leftbtnbgColor:(NSArray *)leftbtnbgColor rightbtnbgColor:(NSArray *)rightbtnbgColor centerbtnColor:(NSArray *)centerbtnColor selectValueArry:(NSArray *)selectValueArry  weightArry:(NSArray *)weightArry
       pickerToolBarFontSize:(NSString *)pickerToolBarFontSize  pickerFontSize:(NSString *)pickerFontSize  pickerFontColor:(NSArray *)pickerFontColor isShowLongTime:(BOOL)isShowLongTime longTimeTitle:(NSString *)longTimeTitle longTimeFontSize:(NSString *)longTimeFontSize longTimeFontColor:(NSArray *)longTimeFontColor longTimeBGColor:(NSArray *)longTimeBGColor

{
    ...
    if (self)
    {
        ...
        self.isShowLongTime=isShowLongTime;
        self.pickerLongTimeText = longTimeTitle;
        self.pickerLongTimeFontSize = longTimeFontSize;
        self.pickerLongTimeFontColor =longTimeFontColor;
        self.pickerLongTimeBg=longTimeBGColor;
...
{
    UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0,0, self.frame.size.width, self.isShowLongTime?92:52)];
    view.backgroundColor = [UIColor cyanColor];// change
    ...
    self.leftBtn.frame = CGRectMake(10, 11, 90, 30);
    [self.leftBtn setTitle:self.leftStr forState:UIControlStateNormal];
    self.leftBtn.titleLabel.font=[UIFont systemFontOfSize:[_pickerToolBarFontSize integerValue]];
    ...
    self.rightBtn.frame = CGRectMake(view.frame.size.width-100,11, 90, 30);
    ...
    self.rightBtn.titleLabel.font=[UIFont systemFontOfSize:[_pickerToolBarFontSize integerValue]];

    [self.rightBtn addTarget:self action:@selector(cfirmAction) forControlEvents:UIControlEventTouchUpInside];
    
    UILabel *cenLabel=[[UILabel alloc]initWithFrame:CGRectMake(90, 11, SCREEN_WIDTH-180, 30)];
    ...
    if (self.isShowLongTime) {
        // change
        UIButton *btn_long = [UIButton buttonWithType:UIButtonTypeCustom];
        btn_long.frame=CGRectMake(0, 52, self.frame.size.width, 40);
        [view addSubview:btn_long];
        [btn_long setBackgroundColor:[self colorWith:self.pickerLongTimeBg]];
        [btn_long setTitle:self.pickerLongTimeText forState:UIControlStateNormal];
        btn_long.titleLabel.font=[UIFont systemFontOfSize:[self.pickerLongTimeFontSize integerValue]];
        [btn_long setTitleColor:[self colorWith:self.pickerLongTimeFontColor] forState:UIControlStateNormal];
        [btn_long addTarget:self action:@selector(loangAction) forControlEvents:UIControlEventTouchUpInside];
        
        UIImageView *line=[[UIImageView alloc]initWithFrame:CGRectMake(0, 91, self.frame.size.width, 1)];
        [view addSubview:line];
        line.backgroundColor=[UIColor colorWithRed:227/255.0 green:227/255.0 blue:227/255.0 alpha:1.0];
    }
    
    // change
    self.pick = [[UIPickerView alloc] initWithFrame:CGRectMake(0, self.isShowLongTime ? 92 : 52, self.frame.size.width, self.frame.size.height - (self.isShowLongTime ? 92 : 52))];
